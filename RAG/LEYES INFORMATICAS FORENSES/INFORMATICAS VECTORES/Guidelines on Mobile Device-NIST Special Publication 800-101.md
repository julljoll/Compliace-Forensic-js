---
source_file: Guidelines on Mobile Device-NIST Special Publication 800-101.md
type: legal_document
---
...
IDENTITY MODULE CHARACTERISTICS ............................................................................. 7 
2.3 
...
Superior speed (~1GHz dual-core) 

Memory 

Limited capacity (~5MB) 

Superior capacity  (~128GB) 
...
Voice and High Speed Data (4G LTE) 
...
13  For  more  information,  visit:  http://appleinsider.com/articles/13/05/14/mobile-malware-exploding-but-only-for-
android 
...
Dime size (length-12.5 mm, width-15 mm, and thickness-1.2 mm) 
...
mode and multi-mode handsets, must include this special method for processing 911 calls22. 
...
22 For more information, visit: http://transition.fcc.gov/pshs/services/911-
...
23 For more information, visit: http://info.sen.ca.gov/pub/bill/asm/ab_1301-
...
24 For more information, visit: http://groups.yahoo.com/group/phoneforensics/ and 
...
Jonathan Zdziarski, iOS Forensic Investigative Methods, 2012, <URL: 
...
The address of the called party, e.g., the 
number dialed by the calling subscriber 
The called number after digit translation within 
the MSC (if applicable) 
The number of the connected party if different 
...
The MSC trunk group on which the call 
...
A list of changes in Location Area Code / Cell 
...
Supplementary services invoked as a result of 
this connection 
The charge advice parameters sent to the MS 
on call setup 
New AOC parameters sent to the MS, e.g., as 
...
The chargeable duration of the connection for 
successful calls, the holding time for call 
attempts 
The type of radio traffic channel (full / half etc.) 
requested by the MS 
The type of radio channel actually used (full or 
half rate) 
A list of changes, each timestamped 
...
Partial record sequence number, only present 
in case of partial records 
A local identifier distinguishing between 
transactions on the same MS 
Charge/no charge indicator and additional 
charging parameters 
A set of network/manufacturer specific 
extensions to the record 
Identifies the CAMEL server serving the 
subscriber 
The CAMEL service logic to be applied 
An identifier to correlate transactions on the 
same call taking place in different network 
nodes, shall be present if CAMEL is applied 
This field contains the E.164 number assigned 
...
applied 
The maximum number of HSCSD channels 
requested as received from the MS at call set-
up 
The number of HSCSD channels allocated to 
...
May be present for HSCSD connections 
...
A list of the traffic channels codings accepted 
...
Speech Version Used 
O 
Speech Version Supported  O 

Number of DP Encountered  O 
...
feature used 
This field contains data sent by the gsmSCF in 
the FCI message 
Set of CAMEL information IEs. Each of these 
...
http://www.nij.gov/topics/forensics/evidence/digital/  
https://htcc.secport.com/mailman/listinfo/htcc 
...
http://www.nij.gov/topics/forensics/evidence/digital/standa
rds/cftt.htm 
http://groups.yahoo.com/group/phoneforensics/ 
http://www.holmes.nl/MPF/FlowChartForensicMobilePhon
eExamination.htm 
http://www.Sdcard.org 
http://www.swgde.org 
...
http://mobile.softpedia.com/phoneFinder 
http://www.numberingplans.com/?page=analysis&sub=im
einr 
http://www.numberingplans.com/?page=analysis&sub=si
mnr 
