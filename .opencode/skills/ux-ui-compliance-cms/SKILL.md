...
#### Tipografía Pericial
- Fuente Ubuntu (Google Fonts) en toda la interfaz — pesos 300, 400, 500, 700
- Evoca documentos periciales modernos y reportes técnicos
...
- **Tipografía Ubuntu**: `font-sans` — siempre mapear a `'Ubuntu', sans-serif`
