    ...
    pasos: [
      {
        ...
        items: [
          'Si no se provee la variable NEXT_PUBLIC_DATABASE_URL, la app guarda todos los datos en IndexedDB local.',
  ...
  },
  {
    ...
    pasos: [
      ...
      },
      {
        id: 'f2p2',
        numero: '2.2',
        titulo: 'Definir Variable de Entorno NEXT_PUBLIC_DATABASE_URL',
        descripcion:
          'La cadena de conexión obtenida de Neon debe ser guardada en la variable correcta. El prefijo NEXT_PUBLIC_ es mandatorio para que Next.js exponga la variable en el frontend.',
        items: [
          'Edita el archivo .env con tu editor de código favorito.',
          'Configura la variable NEXT_PUBLIC_DATABASE_URL pegando la URL de Neon.',
        ...
        codigo: [
          {
            lang: 'bash',
            contenido:
              '# Estructura requerida en el archivo .env\nNEXT_PUBLIC_DATABASE_URL=postgresql://alex_admin:mi_password_segura@ep-sparkling-pooler.us-east-1.aws.neon.tech/neondb?sslmode=require',
          },
        ],
        tags: [
          { label: 'Next.js Env Variable', color: 'yellow' },
        ],
        advertencias: [
          {
    ...
    pasos: [
      ...
      },
      {
        ...
        items: [
          ...
          'En el campo "Name", escribe exactamente: NEXT_PUBLIC_DATABASE_URL',
