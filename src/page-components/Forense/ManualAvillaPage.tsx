 ...
 *
 * Stack: React 19 + TypeScript + Tailwind CSS (Next.js App Router)
...
const FASES: Fase[] = [
    ...
    pasos: [
      {
        ...
        items: [
          ...
          'Firma del acta por el consignante and el perito con fecha y hora exacta (HH:MM Venezuela)',
  ...
  // ══════════════════════════════════════════════════════════════════
  {
    id: 'f4',
    numero: 4,
    titulo: 'Análisis and Validación de Evidencias',
    ...
    pasos: [
      ...
      },
      {
        ...
        items: [
          ...
          'Inventario anual obligatorio de todas las evidencias en resguardo',
        ],
        normativas: [
          { label: 'MUCC-2017 §Almacenamiento', color: 'green' },
          { label: 'ISO 27037 §9', color: 'purple' },
        ],
        icono: Shield,
      },
  ...
  // ══════════════════════════════════════════════════════════════════
  // FASE 6 — SUSTENTACIÓN EN JUICIO ORAL / AUDIENCIA
  // ══════════════════════════════════════════════════════════════════
  {
    id: 'f6',
    numero: 6,
    titulo: 'Sustentación en Juicio Oral / Evacuación',
    subtitulo: 'Defensa técnica de la evidencia e integridad en sala',
    icono: Gavel,
    color: 'text-[#FF3B30]',
    ...
    pasos: [
      {
        id: 'f6p1',
        numero: '6.1',
        titulo: 'Preparación del Escrito de Incorporación',
        descripcion:
          'La evidencia digital no se incorpora sola al expediente; requiere un escrito formal que describa lo entregado y su hash SHA-256 respectivo.',
        items: [
