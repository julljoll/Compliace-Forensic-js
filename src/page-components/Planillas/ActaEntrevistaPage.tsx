...
const ActaEntrevistaPage = () => {
  ...
  const handleDownloadZip = () => {
    downloadPlanillaZip(
      `Acta_Entrevista_${caso?.numeroCaso || 'EXP'}`,
      'Acta de Entrevista Técnico-Pericial — SHA256.US'
    );
  };
  ...
  return (
    <div className="planilla-container">
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            <span style={{ color: '#FECF06', fontWeight: 700, fontSize: '13px' }}>
              Acta de Entrevista Técnico-Pericial (ISO 27037)
            </span>
          </Box>
      ...
      {tabIndex === 0 ? (
        ...
        <PlanillaPdfViewer
          pdfBlob={pdfBlob}
          title={`Acta de Entrevista — Caso #${caso?.numeroCaso || 'N/A'}`}
