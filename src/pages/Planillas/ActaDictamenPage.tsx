      ...
      <div className="page">
        ...
        <div className="section">
          ...
          <div className="grid-container">
            ...
            <div className="form-group"><div className="label">Fecha del Dictamen</div><div className="value"><span className="placeholder-field">[Fecha del Dictamen]</span></div></div>
          </div>
        </div>
          ...
          <table className="evidence-table">
            <tbody>
              <tr>
                ...
                <td>{caso?.tipoProyecto === 'forense_discoduro' ? 'Disco Duro' : 'Móvil / Android'}</td>
              </tr>
              <tr>
                <td>Marca / Modelo</td>
              ...
              <tr>
                ...
                <td><span className="placeholder-field">[N° PRCC Asociado]</span></td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="section">
          ...
          <div className="form-group" style={{ 'marginTop': '10px' }}>
            ...
            <div className="value" style={{ 'minHeight': '40px', 'padding': '5px', 'fontSize': '11px', 'fontWeight': 'bold' }}>
        ...
        <div className="section">
          ...
          <div className="form-group">
            <div className="value examenes-value">
          ...
          <div className="legal-text" style={{ 'marginTop': '8px' }}>
            ...
            <div style={{ 'fontFamily': 'monospace', 'marginTop': '4px', 'fontSize': '9px', 'fontWeight': 'bold' }}>
        ...
        <div className="section">
          ...
          <div className="form-group">
            <div className="value hallazgos-value">
        ...
        <div className="section">
          ...
          <div className="form-group" style={{ 'marginTop': '8px' }}>
            <div className="value conclusiones-value">
              <span className="placeholder-field">
        ...
        <div className="signature-section" style={{ 'gap': '14mm' }}>
          ...
          <div className="sig-detail-card">
            ...
            <div className="sig-line-label">Firma</div>
            <div className="sig-field">
              Nombre: <span className="sig-underline">{caso?.solicitante_nombre ? caso.solicitante_nombre : <span className="placeholder-field">[Nombre del Consignante]</span>}</span>
            </div>
            <div className="sig-field">
              C.I.: <span className="sig-underline">{caso?.solicitante_cedula ? caso.solicitante_cedula : <span className="placeholder-field">[C.I.]</span>}</span>
            </div>
            <div className="fingerprint-row">
              <div className="thumb-wrapper">
                <div className="thumb-box" />
