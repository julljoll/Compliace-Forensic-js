...
const SeguimientoPage = () => {
  const { completedSteps, setStepCompleted, loadCompletedSteps } = useForenseStore();
    ...
    <div className="planilla-container">
      <div className="app-container">
        ...
        <button 
          ...
          title="Imprimir Protocolo de Seguimiento"
        >
          <span>🖨️</span>
        ...
        <main>
          ...
          {/* STEP 1 */}
          <section id="step1" className={`step-card ${activeStep === 'step1' ? 'active' : ''}`}>
            ...
            <div className="doc-box">
              ...
              <div className="doc-filling">
                <strong>Cómo llenarlas:</strong> Deben redactarse en tercera persona, tiempo presente, de manera clara, secuencial y precisa. Indicar circunstancias de modo, tiempo y lugar. Firmadas por el consignatario y funcionario receptor.
              </div>
            </div>
            ...
            <div className="checkbox-container no-print" onClick={() => handleToggleStep('step1')}>
              <input 
                type="checkbox" 
                id="check1" 
                ...
                readOnly
              />
              <label className="checkbox-label" style={{ cursor: 'pointer' }}>Paso Completado</label>
            </div>
          </section>

          {/* STEP 2 */}
          <section id="step2" className={`step-card ${activeStep === 'step2' ? 'active' : ''}`}>
            <div className="card-header">
            ...
            <div className="doc-box">
              ...
              <div className="doc-filling">
                <strong>Cómo llenarlas:</strong> En el Acta de Obtención se debe describir el dispositivo: marca, modelo, IMEI, SIMCard, y estado de la pantalla.
              </div>
            </div>
            <ul className="tutorial-list">
            ...
            <div className="checkbox-container no-print" onClick={() => handleToggleStep('step2')}>
              <input 
                type="checkbox" 
                id="check2" 
          ...
          {/* STEP 3 */}
          <section id="step3" className={`step-card ${activeStep === 'step3' ? 'active' : ''}`}>
            <div className="card-header">
            ...
            <div className="doc-box">
              ...
              <div className="doc-filling">
                <strong>Cómo llenarlas:</strong> Anotar las versiones exactas del software (Andriller) y los algoritmos Hash utilizados.
              </div>
            </div>
            <ul className="tutorial-list">
            ...
            <div className="checkbox-container no-print" onClick={() => handleToggleStep('step3')}>
              <input 
                type="checkbox" 
                id="check3" 
          ...
          {/* STEP 4 */}
          <section id="step4" className={`step-card ${activeStep === 'step4' ? 'active' : ''}`}>
            <div className="card-header">
            ...
            <div className="doc-box">
              ...
              <div className="doc-filling">
                <strong>Cómo llenarlas:</strong> PRCC: Tinta negra/azul, letra de molde, firma manuscrita e impresión dactilar del pulgar derecho. RÓTULO: Tinta indeleble. Incluir Oficina, Expediente, PRCC, descripción y observaciones.
              </div>
            </div>
            <ul className="tutorial-list">
            ...
            <div className="checkbox-container no-print" onClick={() => handleToggleStep('step4')}>
              <input 
                type="checkbox" 
                id="check4" 
          ...
          {/* STEP 5 */}
          <section id="step5" className={`step-card ${activeStep === 'step5' ? 'active' : ''}`}>
            <div className="card-header">
            ...
            <div className="doc-box">
              ...
              <div className="doc-filling">
                <strong>Cómo llenarlas:</strong> PRCC: Firma y pulgar derecho tras verificar precintos. LIBRO: Foliado, asentar fecha, hora y datos del perito que acepta el caso.
              </div>
            </div>
            <ul className="tutorial-list">
            ...
            <div className="checkbox-container no-print" onClick={() => handleToggleStep('step5')}>
              <input 
                type="checkbox" 
                id="check5" 
          ...
          {/* STEP 6 */}
          <section id="step6" className={`step-card ${activeStep === 'step6' ? 'active' : ''}`}>
            <div className="card-header">
            ...
            <div className="doc-box">
              ...
              <div className="doc-filling">
                <strong>Cómo llenarlas:</strong> Garantizar que el reporte liste nombres nativos, fechas, rutas y Hashes individuales.
              </div>
            </div>
            <ul className="tutorial-list">
            ...
            <div className="checkbox-container no-print" onClick={() => handleToggleStep('step6')}>
              <input 
                type="checkbox" 
                id="check6" 
                checked={!!completedSteps['step6']} 
                readOnly
              />
              <label className="checkbox-label" style={{ cursor: 'pointer' }}>Paso Completado</label>
            </div>
          ...
          {/* STEP 7 */}
          <section id="step7" className={`step-card ${activeStep === 'step7' ? 'active' : ''}`}>
            <div className="card-header">
            ...
            <div className="doc-box">
              ...
              <div className="doc-filling">
                <strong>Cómo llenarlas:</strong> NUEVA PRCC: Propio número correlativo, tinta negra/azul, firma y huella. ACTA: Indicar ruta específica de aislamiento desde la evidencia principal.
              </div>
            </div>
            <ul className="tutorial-list">
            ...
            <div className="checkbox-container no-print" onClick={() => handleToggleStep('step7')}>
              <input 
                type="checkbox" 
                id="check7" 
                checked={!!completedSteps['step7']} 
                readOnly
              />
              <label className="checkbox-label" style={{ cursor: 'pointer' }}>Paso Completado</label>
            </div>
          ...
          {/* STEP 8 */}
          <section id="step8" className={`step-card ${activeStep === 'step8' ? 'active' : ''}`}>
            <div className="card-header">
            ...
            <div className="doc-box">
              ...
              <div className="doc-filling">
                <strong>Cómo llenarlas:</strong> Estructura: Motivo, Descripción, Exámenes, Resultados, Conclusiones y Consumo. Firmado y sellado.
              </div>
            </div>
            <ul className="tutorial-list">
            ...
            <div className="checkbox-container no-print" onClick={() => handleToggleStep('step8')}>
              <input 
                type="checkbox" 
                id="check8" 
                checked={!!completedSteps['step8']} 
                readOnly
              />
              <label className="checkbox-label" style={{ cursor: 'pointer' }}>Paso Completado</label>
            </div>
          ...
          {/* STEP 9 */}
          <section id="step9" className={`step-card ${activeStep === 'step9' ? 'active' : ''}`}>
            <div className="card-header">
            ...
            <div className="doc-box">
              ...
              <div className="doc-filling">
                <strong>Cómo llenarlas:</strong> Renglón "Entrega", Motivo: "Traslado" o "Resguardo". Firma y huella del perito.
              </div>
            </div>
            <ul className="tutorial-list">
            ...
            <div className="checkbox-container no-print" onClick={() => handleToggleStep('step9')}>
              <input 
                type="checkbox" 
                id="check9" 
                checked={!!completedSteps['step9']} 
                readOnly
              />
              <label className="checkbox-label" style={{ cursor: 'pointer' }}>Paso Completado</label>
            </div>
