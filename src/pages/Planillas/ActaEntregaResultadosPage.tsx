  ...
  return (
    <div className="planilla-container">
      <div className="page">
        ...
        <div className="section">
          ...
          <div className="grid-container">
            ...
            <div className="form-group"><div className="label">Dirección</div><div className="value"><span className="placeholder-field">[Dirección de Habitación]</span></div></div>
          </div>
        </div>
        ...
        <div className="section">
          ...
          <div className="grid-container">
            <div className="form-group"><div className="label">N° de Expediente / Caso</div><div className="value">{caso?.numeroCaso ? caso.numeroCaso : <span className="placeholder-field">[N° de Expediente]</span>}</div></div>
            <div className="form-group"><div className="label">N° PRCC</div><div className="value"><span className="placeholder-field">[N° PRCC]</span></div></div>
            <div className="form-group"><div className="label">N° Dictamen Pericial</div><div className="value"><span className="placeholder-field">[N° Dictamen]</span></div></div>
            <div className="form-group"><div className="label">Fecha de Entrega</div><div className="value"><span className="placeholder-field">[Fecha de Entrega]</span></div></div>
          </div>
        </div>
        ...
        <div className="section">
          ...
          <div className="form-group" style={{ 'marginTop': '8px' }}>
            ...
            <div className="value dev-observaciones-value">
        ...
        <div className="section">
          ...
          <div className="legal-text" style={{ 'fontSize': '8px' }}>
            <p>Yo, <strong className="placeholder-field">{caso?.solicitante_nombre ? caso.solicitante_nombre : '[Apellidos y Nombres]'}</strong>, titular de la cédula de identidad N° <strong className="placeholder-field">{caso?.solicitante_cedula ? caso.solicitante_cedula : '[C.I.]'}</strong>, 
        ...
        <div className="signature-section" style={{ 'gap': '14mm' }}>
          ...
          <div className="sig-detail-card">
            ...
            <div className="sig-line-label">Firma</div>
            <div className="sig-field">
              C.I.: <span className="sig-underline">{caso?.solicitante_cedula ? caso.solicitante_cedula : <span className="placeholder-field">[C.I. del Consignante]</span>}</span>
            </div>
            <div className="sig-field">
      ...
      <div className="no-print" style={{ 'textAlign': 'center', 'marginTop': '10px', 'marginBottom': '20px', 'display': 'flex', 'justifyContent': 'center', 'gap': '10px' }}>
        ...
        <button onClick={() => downloadPlanillaZip(`ActaEntrega_${caso?.numeroCaso || 'caso'}`, 'Acta de Entrega de Resultados')} className="print-button" style={{ backgroundColor: '#0071E3', borderColor: '#0071E3' }}>
