    ...
    <div className="page">
        ...
        <div className="section">
            ...
            <div className="legal-text" style={{ 'fontSize': '8px' }}>
                <p>Yo, <strong>________________________________</strong>, titular de la cédula de identidad N° <strong>________________</strong>, 
        ...
        <div className="signature-section">
            ...
            <div className="sig-box">
                <div className="sig-label">EL CONSIGNANTE (RECIBÍ CONFORME)</div>
                <div className="sig-sub">Nombre: ____________________</div>
                <div className="sig-sub">C.I.: <span className="box-inline" style={{ 'minWidth': '100px' }}></span></div>
                <div className="sig-sub" style={{ 'marginTop': '15px', 'fontSize': '8px' }}>Firma / Huella</div>
            </div>
        </div>
