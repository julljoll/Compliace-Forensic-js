      ...
      <div className="forensic-card p-6 md:p-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <h2 className="text-xl font-bold text-fluent-text flex items-center gap-3">
            <Scale className="w-6 h-6 text-apple-accent shrink-0" />
            Marco Legal y Estándares Internacionales
          </h2>
          <span className="text-[10px] font-bold bg-apple-accent/10 text-apple-accent px-2 py-1 rounded uppercase tracking-widest self-start sm:self-auto">
            Vigente 2024
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <h4 className="text-xs font-bold text-apple-accent-light uppercase flex items-center gap-2 tracking-widest">
          ...
          <div className="space-y-4">
            <h4 className="text-xs font-bold text-apple-accent-light uppercase tracking-widest">Procedimientos</h4>
            <ul className="text-sm text-fluent-textSecondary space-y-3">
              <li className="flex items-start gap-2">
                <div className="mt-1.5 w-1 h-1 rounded-full bg-fluent-border shrink-0"></div>
        ...
        <div className="mt-10 pt-8 border-t border-fluent-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-fluent-surface border border-fluent-border p-5 rounded-fluent-card group hover:bg-fluent-surfaceHover transition-all">
              <span className="text-apple-accent-light font-bold text-xs block mb-2 tracking-widest uppercase">Resguardo y Custodia</span>
            ...
            <div className="bg-fluent-surface border border-fluent-border p-5 rounded-fluent-card group hover:bg-fluent-surfaceHover transition-all">
              <span className="text-apple-accent-light font-bold text-xs block mb-2 tracking-widest uppercase">Trazabilidad de Transferencia</span>
              <p className="text-xs text-fluent-textSecondary leading-relaxed">
