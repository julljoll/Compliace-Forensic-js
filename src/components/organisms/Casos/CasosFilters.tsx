...
export default function CasosFilters({
  ...
  return (
    <div className="apple-acrylic p-4 rounded-xl flex flex-wrap items-center gap-4">
      <div className="flex items-center gap-3 flex-1 min-w-[240px] bg-white border border-black/[0.08] rounded-[8px] px-3 py-2 focus-within:border-[#0071E3] focus-within:shadow-[0_0_0_3px_rgba(0,113,227,0.15)] transition-all">
        ...
        <input
          ...
          className="bg-transparent text-sm text-[#1D1D1F] placeholder:text-[#86868B]/40 outline-none flex-1 font-medium"
        />
      </div>
      <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
        <div className="flex items-center gap-2 flex-1 sm:flex-none">
           ...
           <select 
             ...
             className="flex-1 sm:flex-none bg-white border border-black/[0.08] rounded-[8px] px-3 py-2 text-xs font-bold text-[#86868B] outline-none focus:border-[#0071E3] focus:shadow-[0_0_0_3px_rgba(0,113,227,0.15)] hover:border-black/20 transition-all cursor-pointer appearance-none"
           >
